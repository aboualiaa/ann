...
//
// where
//		dim				is the dimension of the space (default
//= 2) 		mpts			maximum number of data points (default = 1000)
//		k				number of nearest neighbors per query
//(default 1) 		eps				is the error bound (default =
//0.0) 		data			file containing data points 		query
